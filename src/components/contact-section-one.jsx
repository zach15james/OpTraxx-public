    ...
    return (
        <section className="bg-[#F8FAFC] py-15 sm:py-24 lg:py-32">
            <div className="mx-auto max-w-4xl px-4 lg:px-0">
                ...
                <h1 className="text-center text-balance text-3xl font-bold text-[#0F172A] md:text-4xl lg:text-5xl">Get in touch with the team</h1>
                <p className="mt-4 text-center text-lg text-muted-foreground">Whether you have questions about pricing, features, or getting your team set up, we're happy to help.</p>
                <div className="mt-10 grid gap-12 lg:grid-cols-5">
                    <div className="grid grid-cols-2 lg:col-span-2 lg:block lg:space-y-12">
                        ...
                        <div className="flex flex-col justify-between space-y-6">
                            <div>
                                <h3 className="mb-3 text-lg font-semibold text-[#0F172A]">Enterprise Plan Sales</h3>
                    ...
                    <form action="" className="@container lg:col-span-3">
                        <Card className="p-8 sm:p-12">
                            ...
                            <div className="**:[&>label]:block mt-12 space-y-6 *:space-y-3">
                                ...
                                <Button className="bg-[#2563eb] text-white hover:bg-[#2563eb]/90">Submit</Button>
                            </div>
                        </Card>
                    </form>
                </div>
